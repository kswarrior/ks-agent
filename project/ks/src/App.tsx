    ...
    <div className="layout">
      <aside className="sidebar">
        ...
        <nav className="sidebar-nav">
          <button onClick={() => setActive('dashboard')} className={`sidebar-item ${active === 'dashboard' ? 'active' : ''}`}>
            <span aria-hidden="true">
              <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"/><polyline points="9 22 9 12 15 12 15 22"/></svg>
            </span> Dashboard
          </button>
          <button onClick={() => setActive('servers')} className={`sidebar-item ${active === 'servers' ? 'active' : ''}`}>
            <span aria-hidden="true">
          ...
          <button onClick={() => setActive('players')} className={`sidebar-item ${active === 'players' ? 'active' : ''}`}>
            <span aria-hidden="true">
              <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M23 21v-2a4 4 0 0 0-3-3.87"/><path d="M16 3.13a4 4 0 0 1 0 7.75"/></svg>
            </span> Players
          </button>
          <button onClick={() => setActive('console')} className={`sidebar-item ${active === 'console' ? 'active' : ''}`}>
            <span aria-hidden="true">
          ...
          <button onClick={() => setActive('analytics')} className={`sidebar-item ${active === 'analytics' ? 'active' : ''}`}>
            <span aria-hidden="true">
              <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><line x1="18" y1="20" x2="18" y2="10"/><line x1="12" y1="20" x2="12" y2="4"/><line x1="6" y1="20" x2="6" y2="14"/></svg>
            </span> Analytics
          </button>
          <button onClick={() => setActive('security')} className={`sidebar-item ${active === 'security' ? 'active' : ''}`}>
            <span aria-hidden="true">
      ...
      {active === 'security' && <div className="page"><Security /></div>}
      {active === 'servers' && <div className="page"><Servers /></div>}
