---
name: frontend-react
description: Use when building React 18 components, hooks, state, routing with Vite or Next.js — frontend React specialist for user websites
---
...
> Mirrored from `skills/frontend/react.md`.
