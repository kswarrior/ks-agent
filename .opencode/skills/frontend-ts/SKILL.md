---
name: frontend-ts
description: Use when writing TypeScript for frontend React sites, strict types, tsconfig, Vite config or type syncing between frontend and backend
---
...
> Mirrored from `skills/frontend/ts.md`.
