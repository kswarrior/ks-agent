---
name: frontend
description: Use when building frontend website, React Vite UI, CSS components, landing page or styling web/src files — covers tokens, responsive layout and custom modals
---
...
> This skill is mirrored from `skills/frontend/skill.md` (KS Agent source). Canonical content lives at `skills/frontend/skill.md` — keep both in sync.
