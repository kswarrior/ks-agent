---
name: refactoring
description: Use when refactoring, cleaning up or extracting code — behavior must stay identical, prove with before/after curl/build diffs
---
...
> Mirrored from `skills/refactoring.md`.
