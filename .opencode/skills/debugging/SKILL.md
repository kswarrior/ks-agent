---
name: debugging
description: Use when debugging, fixing bugs, reproducing errors or tracing 500s — systematic reproduce→root cause→minimal fix for Node Hono React
---
...
> Mirrored from `skills/debugging.md`.
