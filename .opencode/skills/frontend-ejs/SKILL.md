---
name: frontend-ejs
description: Use when building EJS server-rendered pages, email templates or Express views — EJS syntax for user websites
---
...
> Mirrored from `skills/frontend/ejs.md`.
...
Never mix stacks — choose one for the user project and keep it standalone.
...
5. **Standalone** — Generated EJS site must be fully standalone with no internal strings/paths. It must run with `npm install && npm run dev` alone.
...
- [ ] No internal strings/paths in output — fully standalone
