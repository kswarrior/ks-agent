---
name: testing
description: Use when testing, verifying builds, typecheck or manual curl checks — npm run typecheck, npm run build, retest.sh workflow for KS Agent
---
...
> Mirrored from `skills/testing.md`.
