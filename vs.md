...
*   **Honest vs prior inflated version:** Inflated 1135 (94.6, claimed beats all personas) reverted to honest **1131 (94.3)** with measured lifts (+91 over original 1040, not +95) and honest scenario/persona rankings — plus C13 folded separately (KS 1219/93.8 with delegation at 88). See §4.2 evidence notes + §3 row (✅).
